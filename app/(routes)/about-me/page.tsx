...
const About = () => {
    return ( 
        <main className="flex min-h-screen  flex-col items-center justify-between p-12 max-w-screen-2xl mx-auto ">
            ...
            <div className="shadow-2xl bg-gradient-to-b from-slate-50/15 p-3 mb-96 to-transparent  flex-crow w-[100%] max-w-[1024px] rounded z-10 min-h-[600px] h-auto relative backdrop-blur-lg ">
                <TimeLine />
            </div>
        </main>
     );
